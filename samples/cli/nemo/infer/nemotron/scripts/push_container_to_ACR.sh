...
docker build -t $registryname.azurecr.io/nim_nemotron_ncd -f scripts/auxiliary_files/Dockerfile_aml.yml .

echo "Pushing the image to ACR"
docker push ${registryname}.azurecr.io/nim_nemotron_ncd:latest
