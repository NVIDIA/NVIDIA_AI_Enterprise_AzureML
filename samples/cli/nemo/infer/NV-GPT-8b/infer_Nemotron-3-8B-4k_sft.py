...
def main():
	...
	client = httpclient.InferenceServerClient(url="nemo-llama-endpoint-aml-mayani-1.westeurope.inference.ml.azure.com/",ssl=True, ssl_context_factory=gevent.ssl._create_default_https_context)
	
	headers = {'Content-Type':'application/json', 'Authorization':('Bearer '+ api_key), 'azureml-model-deployment': 'nemo-llama-deployment-3'}
