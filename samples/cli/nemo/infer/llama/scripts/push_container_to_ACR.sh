...
docker build -t $registryname.azurecr.io/tme_genai_model_server_ncd -f scripts/auxiliary_files/Dockerfile_aml.yml .

echo "Pushing the image to ACR"
docker push ${registryname}.azurecr.io/tme_genai_model_server_ncd:latest
